...
checkpoint = ModelCheckpoint("model_work/R_CFST_Me/my_model/best_model.h5", save_best_only=True)
# TensorBoard callback for profiling
tensorboard = TensorBoard(log_dir="logs/")

# Train the model
model.fit(X_train, y_train, epochs=20000, batch_size=len(X_train), verbose=2, validation_data=(X_test, y_test),
...
model = tf.keras.models.load_model('model_work/R_CFST_Me/my_model/best_model.h5')

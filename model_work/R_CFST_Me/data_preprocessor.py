...
class DataPreprocessor:
    ...
    def __init__(self, denormalize_data=False):
        ...
        self.csv_file_path = 'DATA/R_CFST_Me.csv'
        self.csv_file_index = 4
        self.columns_names = ['b (mm)', 'h (mm)', 't (mm)', 'L (mm)', 'fy (MPa)', 'fc (MPa)', 'et (mm)', 'eb (mm)',
                              'N Test (kN)']
        self.read_file()
    ...
    def prepare_data_frame(self):
        ...
        with open('model_work/R_CFST_Me/my_model/data_scaler.pkl', 'wb') as f:
